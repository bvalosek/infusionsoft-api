...
// The Affiliate Program Service allows access to some of features in the
...
.interface('IAffiliateProgramService') .implements(IService) .define({

    // Gets a list of all of the affiliates with their contact data for the
    // specified program. This includes all of the custom fields defined for
    // the contact and affiliate records that are retrieved.
    __xmlrpc__getAffiliatesByProgram: function(programId) {},

    // Gets a list of all of the Affiliate Programs for the Affiliate
    // specified.
    __xmlrpc__getProgramsForAffiliate: function(affiliateId) {},

    // Gets a list of all of the Affiliate Programs that are in the
    // application.
    __xmlrpc__getAffiliatePrograms: function() {},

    // Gets a list of all of the resources that are associated to the
