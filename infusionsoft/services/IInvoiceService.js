...
.interface('IInvoiceService') .implements(IService) .define({
    ...
    // due on an invoice
    __xmlrpc__chargeInvoice: function(invoiceId, notes, creditCardId,
    ...
    __xmlrpc__addRecurringOrder: function(contactId, allowDuplicate,
        cProgramId, qty, price, taxable, merchantAccountId, creditCardId,
        affiliateId, daysTillCharge) {},
    ...
    // subscription.
    __xmlrpc__addRecurringCommissionOverride: function(recurringOrderId,
    ...
    __xmlrpc__addManualPayment: function(invoiceId, amt, paymentDate,
        paymentType, paymentDescription, bypassCommissions) {},

    // Allows you to setup a custom payment plan for an invoice.
    __xmlrpc__addPaymentPlan: function(invoiceId, autoCharge, creditCardId,
        merchantAccountId, daysBetweenRetry, maxRetry, initialPmtAmt,
        initialPmtDate, planStartDate, numPmts, daysBetweenPmts) {},
    ...
    __xmlrpc__getAllPaymentOptions: function() {},
    ...
    __xmlrpc__updateJobRecurringNextBillDate: function(recurringOrderId,
        nextBillDate) {},

    // Creates a commission on an existing invoice.
    __xmlrpc__addOrderCommissionOverride: function(invoiceId, affiliateId,
        productId, percentage, amount, payoutType, description, date) {}
